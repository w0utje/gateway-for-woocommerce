...
class WcWavesGateway extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->currencyIsWaves = in_array(get_woocommerce_currency(), array("WAVES","WNET","ARTcoin","POL","Wykop Coin","TN","Ecop","Mango","SilkRoadCoin","Localpromo Euro","BearWaves"));
        if($this->currencyIsWaves) {
            if (get_woocommerce_currency() == "Waves") {
                ...
                $this->assetId = '5HtYMme8QxH8CzQGCFQ1XUZ3Zf262tsvKpQtrpFEW9jU';
                  ...
                  $this->assetCode = 'BearWaves';
                  $this->assetId = '9gnc5UCY6RxtSi9FEJkcD57r5NBgdr45DVYtunyDLrgC';
  				}
        } else {
